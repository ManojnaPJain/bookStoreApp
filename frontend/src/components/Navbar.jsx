...
function Navbar() {
  ...
  return (
    <>
    <div 
    className={` max-w-screen-2xl container mx-auto md:px-20 px-4 dark:bg-slate-900 dark:text-white fixed top-0 left-0 ${sticky 
  ...
  <div className="navbar-start">
    ...
    <a className="btn btn-ghost text-2x bold ">Bookstore</a>
  </div>
...
<label className="swap swap-rotate">
  ...
  {/* sun icon */}
  <svg className="swap-off fill-current w-8 h-10" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
  ...
  {/* moon icon */}
  <svg className="swap-on fill-current w-8 h-10" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
  ...
  <div className="">
    <a className="btn bg-black text-white px-3 py-2"
